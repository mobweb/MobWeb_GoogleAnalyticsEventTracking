// Taken from http://www.blastam.com/blog/index.php/2013/03/how-to-track-downloads-in-google-analytics-v2
        ...
        jQuery('a').on('click', function(event) {
            ...
            if (!href.match(/^javascript:/i)) {
                ...
                if (track) {
                    ...
                    if(typeof gax != 'undefined') {
                        ga('send', eventData);
                    } else if(typeof _gaqx != 'undefined') {
